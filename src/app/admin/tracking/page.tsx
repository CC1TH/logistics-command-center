...
export default function TrackingPage() {
  ...
  const toggleLock = (index: number) => {
    setTrips(prev => {
      const arr = [...prev]
      arr[index].isLocked = !arr[index].isLocked
      return arr
    })
  }

  const toggleStatus = (index: number, color: 'ovn' | 'wait') => {
    setTrips(prev => {
      const arr = [...prev]
      arr[index].statusColor = arr[index].statusColor === color ? 'default' : color
      return arr
    })
  }
      ...
      <header className="bg-white shadow">
        <div className="max-w-5xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <Link href="/admin/vehicles" className="text-sm text-blue-600 hover:underline">← กลับจัดการรถ</Link>
          </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    disabled={isLocked}
                    className="w-full p-2 border rounded bg-white/80 disabled:bg-gray-100" 
              ...
              <div className="mb-4">
                ...
                <input 
                  ...
                  disabled={isLocked}
                  className="w-full p-2 border rounded bg-white/80 disabled:bg-gray-100 font-mono" 
              ...
              <div className="mb-4">
                ...
                <input 
                  ...
                  disabled={isLocked}
                  className="w-full p-2 border rounded bg-white/80 disabled:bg-gray-100 font-medium" 
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2 border-t border-black/10">
                ...
                <div className="ml-auto flex gap-2">
                  <button onClick={() => saveBlock(idx)} disabled={isLocked} className="bg-green-600 text-white px-4 py-1.5 rounded hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium">💾 บันทึก</button>
                  <button onClick={() => toggleLock(idx)} className="bg-blue-600 text-white px-4 py-1.5 rounded hover:bg-blue-700 text-sm font-medium">
                    {isLocked ? '🔓 แก้ไข' : '🔒 ล็อก'}
                  </button>
                </div>
              </div>
